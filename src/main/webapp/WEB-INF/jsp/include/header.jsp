...
<%-- <div style="float:left; margin-left:20px;"><a href="/WEB-INF/jsp/addlist.jsp">TODOリスト追加</a></div>--%>
<div style="float:left; margin-left:20px;"><a href="/healthylife/Add">病名追加</a></div>
<%-- <div style="float:left;"><p>ID:  <%= loginUser.getUserId() %>     NAME:  <%= loginUser.getUserName() %></p></div>--%>

<div style="float:left; margin-left:310px;"><p><a href="/healthylife/UserUpdate">会員情報修正</a></p></div>
